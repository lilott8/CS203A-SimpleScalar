...
./sim-outorder -DVFSTargetPower 19.8835 -DVFSInterval 100 ./benchmarks/anagram.alpha < ./benchmarks/anagram.in

#./sim-outorder -DVFSTargetPower 60.8711 -DVFSInterval 100 ./benchmarks/go.alpha 2 8 2stone9.in
